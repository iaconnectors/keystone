...
class WikipediaConnector:
    ...
    def fetch(self, topic: str) -> Optional[ExternalResult]:
        ...
        try:
            resp = requests.get(self.API_URL.format(title=slug), timeout=5)
...
class WikidataConnector:
    ...
    def fetch(self, topic: str) -> Optional[ExternalResult]:
        try:
            ...
            entity_resp = requests.get(self.ENTITY_URL.format(entity=entity_id), timeout=5)
...
class ExternalKnowledgeHub:
    ...
    def __init__(self) -> None:
        self.connectors = [WikipediaConnector(), WikidataConnector()]
